  ...
  return (
    <div className="scrollbar-none">
      {loading ? (
        ...
        <>
          <div
            className=" flex flex-wrap overflow-y-auto h-screen 
          ...
          <div
            className="  h-32 scrollbar-thin scrollbar-thumb-main_color-800 scrollbar-track-main_color-1000
  scroll-smooth   w-1/5 mx-auto flex items-center p-8 overflow-x-auto "
          >
            {btns.map((item, index) => (
              <button
                className="btn ml-2    bg-main_color-600 pt-1 pb-1 pl-2 pr-2
